			...
			for(var i in options.data) {
				this.models.push(new tableModel(this, options.data[i]).on('check', function(){
						...
						if(this.renderObj.checked_count == this.models.length){
							...
							checkbox.attr('class', 'fa fa-lgf a-fixed fa-square-o');
						}else{
