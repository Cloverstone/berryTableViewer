...
templates["mobile_head"] = new Hogan.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");if(t.s(t.d("options.hasActions",c,p,1),c,p,0,23,154,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("  <div style=\"width: 60px;min-width:60px;padding: 0 0 0 20px;\"><i data-event=\"select_all\" class=\"fa fa-2x fa-square-o\"></i></div>");t.b("\n" + i);});c.pop();}t.b("<div>");t.b("\n");t.b("\n" + i);if(t.s(t.d("options.sort",c,p,1),c,p,0,204,1076,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("\n" + i);if(t.s(t.d("options.filter",c,p,1),c,p,0,227,581,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("      <div name=\"reset-search\" style=\"position:relative\" class=\"btn btn-default\" data-toggle=\"tooltip\" data-placement=\"left\" title=\"Clear Filters\">");t.b("\n" + i);t.b("        <i class=\"fa fa-filter\"></i>");t.b("\n" + i);t.b("        <i class=\"fa fa-times text-danger\" style=\"position: absolute;right: 5px;\"></i>");t.b("\n" + i);t.b("      </div>    ");t.b("\n");t.b("\n" + i);t.b("    <div class=\"btn btn-info filterForm\">Column Filter</div>");t.b("\n" + i);});c.pop();}t.b("    ");t.b("\n" + i);t.b("    <div class=\"input-group\">");t.b("\n" + i);t.b("      <span class=\"input-group-btn\">");t.b("\n" + i);t.b("        <button class=\"btn btn-default reverse\" type=\"button\" tabindex=\"-1\"><i class=\"fa fa-sort text-muted\"></i></button>");t.b("\n" + i);t.b("      </span>");t.b("\n" + i);t.b("        <select class=\"form-control sortBy\">");t.b("\n" + i);t.b("          <option value=true>None</option>");t.b("\n" + i);if(t.s(t.f("items",c,p,1),c,p,0,918,1035,"{{ }}")){t.rs(c,p,function(c,p,t){if(t.s(t.f("visible",c,p,1),c,p,0,943,1012,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("              <option value=\"");t.b(t.v(t.f("id",c,p,0)));t.b("\">");t.b(t.v(t.f("label",c,p,0)));t.b("</option>");t.b("\n" + i);});c.pop();}});c.pop();}t.b("        <select>");t.b("\n" + i);t.b("    </div>");t.b("\n" + i);});c.pop();}t.b("\n" + i);t.b("</div>");return t.fl(); },partials: {}, subs: {  }});
