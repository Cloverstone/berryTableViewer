...
templates["table"] = new Hogan.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<div class=\"well\" style=\"background:#fff\">");t.b("\n" + i);t.b("	<div style=\"height:40px\">");t.b("\n" + i);t.b("		<input type=\"file\" class=\"csvFileInput\" accept=\".csv\" style=\"display:none\">");t.b("\n");t.b("\n" + i);t.b("		<div class=\"hiddenForm\" style=\"display:none\"></div>");t.b("\n" + i);t.b("		<div class=\"btn-group pull-right\" style=\"margin-bottom:10px\" role=\"group\" aria-label=\"...\">");t.b("\n" + i);if(t.s(t.f("showAdd",c,p,1),c,p,0,312,413,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("			<div data-event=\"add\" class=\"btn btn-success\"><i class=\"fa fa-pencil-square-o\"></i> New</div>");t.b("\n" + i);});c.pop();}if(t.s(t.d("options.download",c,p,1),c,p,0,450,603,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("			<div class=\"btn btn-default\" name=\"bt-download\" data-toggle=\"tooltip\" data-placement=\"left\" title=\"Download\"><i class=\"fa fa-download\"></i></div>");t.b("\n" + i);});c.pop();}if(t.s(t.d("options.upload",c,p,1),c,p,0,647,794,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("			<div class=\"btn btn-default\" name=\"bt-upload\" data-toggle=\"tooltip\" data-placement=\"left\" title=\"Upload\"><i class=\"fa fa-upload\"></i></div>");t.b("\n" + i);});c.pop();}t.b("\n" + i);if(t.s(t.d("options.filter",c,p,1),c,p,0,837,1086,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("			<div name=\"reset-search\" class=\"btn btn-default\" data-toggle=\"tooltip\" data-placement=\"left\" title=\"Clear Filters\">");t.b("\n" + i);t.b("				<i class=\"fa fa-filter\"></i>");t.b("\n" + i);t.b("				<i class=\"fa fa-times text-danger\" style=\"position: absolute;right: 5px;\"></i>");t.b("\n" + i);t.b("			</div>");t.b("\n" + i);});c.pop();}if(t.s(t.d("options.columns",c,p,1),c,p,0,1129,1890,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("			<div class=\"btn-group columnEnables\" data-toggle=\"tooltip\" data-placement=\"left\" title=\"Display Columns\">");t.b("\n" + i);t.b("			  <button class=\"btn btn-default dropdown-toggle\" type=\"button\" id=\"enables_");t.b(t.v(t.d("options.id",c,p,0)));t.b("\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"true\">");t.b("\n" + i);t.b("			    <i class=\"fa fa-list\"></i>");t.b("\n" + i);t.b("			    <span class=\"caret\"></span>");t.b("\n" + i);t.b("			  </button>");t.b("\n" + i);t.b("			  <ul class=\"dropdown-menu pull-right\" style=\"padding-top:10px\" aria-labelledby=\"enables_");t.b(t.v(t.d("options.id",c,p,0)));t.b("\">");t.b("\n" + i);if(t.s(t.f("items",c,p,1),c,p,0,1609,1855,"{{ }}")){t.rs(c,p,function(c,p,t){if(t.s(t.f("visible",c,p,1),c,p,0,1628,1835,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("			    <li><label data-field=\"");t.b(t.v(t.f("id",c,p,0)));t.b("\" style=\"width:100%;font-weight:normal\"><input type=\"checkbox\" ");if(t.s(t.f("isEnabled",c,p,1),c,p,0,1742,1759,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("checked=\"checked\"");});c.pop();}t.b(" style=\"margin: 5px 0 5px 15px;\"> ");t.b(t.v(t.f("label",c,p,0)));t.b("</label></li>");t.b("\n" + i);});c.pop();}});c.pop();}t.b("			  </ul>");t.b("\n" + i);t.b("			</div>");t.b("\n" + i);});c.pop();}t.b("\n" + i);t.b("		</div>");t.b("\n");t.b("\n" + i);t.b("		<div name=\"events\" class=\" pull-left\" style=\"margin-bottom:10px\" ></div>");t.b("\n" + i);t.b("		");if(t.s(t.d("options.search",c,p,1),c,p,0,2018,2147,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("<input type=\"text\" name=\"search\" class=\"form-control pull-right\" style=\"max-width:300px; margin-right:15px\" placeholder=\"Search\">");});c.pop();}t.b("\n");t.b("\n" + i);t.b("	</div>	");t.b("\n");t.b("\n" + i);if(!t.s(t.d("options.autoSize",c,p,1),c,p,1,0,0,"")){t.b("	<div class=\"paginate-footer\" style=\"overflow:hidden;margin-top:10px;clear:both\"></div>");t.b("\n" + i);};t.b("\n" + i);t.b("	<div class=\"table-container\" style=\"width:100%;overflow:auto\">");t.b("\n" + i);if(t.s(t.d("options.autoSize",c,p,1),c,p,0,2399,3331,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("	<table class=\"table ");if(!t.s(t.d("options.noborder",c,p,1),c,p,1,0,0,"")){t.b("table-bordered");};t.b("\" style=\"margin-bottom:0px\">");t.b("\n");t.b("\n" + i);t.b("		<thead>");t.b("\n" + i);t.b("		<tr style=\"background:#fff;cursor:pointer\" class=\"noselect\">");t.b("\n" + i);if(t.s(t.d("options.hasActions",c,p,1),c,p,0,2606,2745,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("			<th style=\"width: 60px;min-width:60px;padding: 0 0 0 10px;\"><i data-event=\"select_all\" class=\"fa fa-fw fa-2x fa-square-o\"></i></th>");t.b("\n" + i);});c.pop();}t.b("\n" + i);if(t.s(t.f("items",c,p,1),c,p,0,2783,2995,"{{ }}")){t.rs(c,p,function(c,p,t){if(t.s(t.f("visible",c,p,1),c,p,0,2799,2979,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("			<th data-sort=\"");t.b(t.v(t.f("cname",c,p,0)));t.b("\"><h6 style=\"margin: 2px;font-size:13px;white-space: nowrap\">");if(t.s(t.d("options.sort",c,p,1),c,p,0,2905,2943,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("<i class=\"fa fa-sort text-muted\"></i> ");});c.pop();}t.b(t.v(t.f("label",c,p,0)));t.b("</h6></th>");});c.pop();}t.b("\n" + i);});c.pop();}t.b("\n" + i);t.b("		</tr>		");t.b("\n");t.b("\n" + i);if(t.s(t.d("options.filter",c,p,1),c,p,0,3039,3289,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("		<tr style=\"background:#fff;\" class=\"filter\">");t.b("\n" + i);t.b("			");if(t.s(t.d("options.hasActions",c,p,1),c,p,0,3113,3122,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("<td></td>");});c.pop();}t.b("\n");t.b("\n" + i);if(t.s(t.f("items",c,p,1),c,p,0,3160,3268,"{{ }}")){t.rs(c,p,function(c,p,t){if(t.s(t.f("visible",c,p,1),c,p,0,3176,3252,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("			<td data-inline=\"");t.b(t.v(t.f("cname",c,p,0)));t.b("\" style=\"min-width:85px\" id=\"");t.b(t.v(t.f("id",c,p,0)));t.b("\"></td>");t.b("\n" + i);});c.pop();}});c.pop();}t.b("		</tr>");t.b("\n" + i);});c.pop();}t.b("\n" + i);t.b("	</thead>");t.b("\n" + i);t.b("	</table>");t.b("\n" + i);});c.pop();}t.b("\n");t.b("\n" + i);t.b("	<div style=\"min-height:100px\">");t.b("\n" + i);t.b("		<table class=\"table ");if(!t.s(t.d("options.noborder",c,p,1),c,p,1,0,0,"")){t.b("table-bordered");};t.b(" table-striped table-hover dataTable\" style=\"margin-bottom:0px\">");t.b("\n" + i);if(!t.s(t.d("options.autoSize",c,p,1),c,p,1,0,0,"")){t.b("			<thead>");t.b("\n" + i);t.b("				<tr style=\"background:#fff;cursor:pointer\" class=\"noselect\">");t.b("\n" + i);if(t.s(t.d("options.hasActions",c,p,1),c,p,0,3659,3802,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("					<th style=\"width: 60px;min-width:60px;padding: 0 0 0 10px;\"><i data-event=\"select_all\" class=\"fa fa-fw fa-2x fa-square-o\"></i></th>");t.b("\n" + i);});c.pop();}t.b("\n" + i);if(t.s(t.f("items",c,p,1),c,p,0,3842,4066,"{{ }}")){t.rs(c,p,function(c,p,t){if(t.s(t.f("visible",c,p,1),c,p,0,3860,4048,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("					<th data-sort=\"");t.b(t.v(t.f("cname",c,p,0)));t.b("\"><h6 style=\"margin: 2px;font-size:13px;white-space: nowrap\">");if(t.s(t.d("options.sort",c,p,1),c,p,0,3968,4006,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("<i class=\"fa fa-sort text-muted\"></i> ");});c.pop();}t.b(t.v(t.f("label",c,p,0)));t.b("</h6></th>");t.b("\n" + i);});c.pop();}});c.pop();}t.b("				</tr>");t.b("\n" + i);if(t.s(t.d("options.filter",c,p,1),c,p,0,4110,4378,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("				<tr style=\"background:#fff;\" class=\"filter\">");t.b("\n" + i);t.b("					");if(t.s(t.d("options.hasActions",c,p,1),c,p,0,4188,4197,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("<td></td>");});c.pop();}t.b("\n");t.b("\n" + i);if(t.s(t.f("items",c,p,1),c,p,0,4237,4353,"{{ }}")){t.rs(c,p,function(c,p,t){if(t.s(t.f("visible",c,p,1),c,p,0,4255,4335,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("					<td data-inline=\"");t.b(t.v(t.f("cname",c,p,0)));t.b("\" style=\"min-width:85px\" id=\"");t.b(t.v(t.f("id",c,p,0)));t.b("\"></td>");t.b("\n" + i);});c.pop();}});c.pop();}t.b("				</tr>");t.b("\n" + i);});c.pop();}t.b("\n" + i);t.b("			</thead>");t.b("\n" + i);};t.b("\n" + i);t.b("			<tbody class=\"list-group\">");t.b("\n" + i);t.b("				<tr><td>");t.b("\n" + i);t.b("					<div class=\"alert alert-info\" role=\"alert\">You have no items.</div>");t.b("\n" + i);t.b("				</td></tr>");t.b("\n" + i);t.b("			</tbody>");t.b("\n");t.b("\n" + i);t.b("		</table>");t.b("\n" + i);t.b("	</div>");t.b("\n");t.b("\n" + i);t.b("	</div>");t.b("\n" + i);t.b("	<div class=\"paginate-footer\" style=\"overflow:hidden;margin-top:10px\"></div>");t.b("\n" + i);t.b("</div>");return t.fl(); },partials: {}, subs: {  }});
