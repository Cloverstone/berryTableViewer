...
_.each(	this.$el.find('.list-group tr:first td'), function(item, index){
		this.$el.find('.table-responsive > table tr th')[index].style.width = item.offsetWidth+'px';
}.bind(this))
